                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row justify-content-center">
                                    ...
                                    <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('surname') }}</label>
                                 ...
                                 <div class="form-group row ">
                                    <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('birthday') }}</label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @endif
                                         ...
                                         <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('blood_group') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('age') }}</label>
