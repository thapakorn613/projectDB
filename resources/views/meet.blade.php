...
<div class="container">
    ...
    @csrf
        <label for="name" class="col-md-2 col-form-label text-md-center">{{ __('  Doctor  ') }}</label>
        <div class="col-md-4">
        ...
        <label for="name" class="col-md-2 col-form-label text-md-center">{{ __('  Date  ') }}</label>
        <div class="col-md-4">
        ...
        <label for="name" class="col-md-2 col-form-label text-md-center">{{ __('  Time  ') }}</label>
        <div class="col-md-4">
